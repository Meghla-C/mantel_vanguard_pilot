...
@patch("readers.APIReaderByID.APIReaderByID._add_api_metadata")
@patch("readers.APIReaderByID.APIReaderByID.get_api_credentials")
@patch("readers.APIReaderByID.APIReaderByID.make_http_request")
@patch("readers.APIReaderByID.APIReaderByID.make_concurrent_http_requests")
def test_read_source_to_dataframe(
    mock_make_concurrent_http_requests,
    ...
    mock_make_concurrent_http_requests.return_value = [
        '{"key1": "value1"}',
        '{"key2": "value2"}',
    ]

    api_reader = APIReaderByID(entity_config, spark_mock, dbutils_mock)
    ...
    mock_make_concurrent_http_requests.assert_called_once_with(
        url_list=[
            "http://mockhost/rest/test/value1",
            "http://mockhost/rest/test/value2",
        ],
        host_endpoint="http://mockhost",
        username="mock_user",
        password="mock_pass",
